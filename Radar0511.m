...
s_echo_i=receiver_oscillator_i.* RealEchoAll;%I路解调
s_echo_q=receiver_oscillator_q.* RealEchoAll;%Q路解调
...
%% 回波信号整形
Folder = {'时域脉压','时频域脉压对比','频域脉压幅度','MTI','MTD','cfar'};
...
%     close(gcf)
    ...
    hug2 = figure('visible','off');
    subplot(2,1,1),plot((0:1/fs:PulseNumber*M/fs-1/fs),abs(s_pc_result_1)),
